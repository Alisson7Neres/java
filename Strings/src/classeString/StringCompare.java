...
public class StringCompare {
	...
	public static void main(String[] args) {
		...
		// teste quando á igualdade com ==
		if(s1 == "hello") { // false; eles não são os mesmo objetos
			System.out.println("s1 is the same object as \"hello\"");
		} else {
			System.out.println("s1 is not the shame object as \"hello\"");
		}
		...
		System.out.printf(
				"%ns1.compareTo(s1) is %d", s2.compareTo(s1));
		System.out.printf(
				"%ns1.compareTo(s1) is %d", s1.compareTo(s1));
		System.out.printf(
				"%ns1.compareTo(s4) is %d", s3.compareTo(s4));
		System.out.printf(
				"%ns1.compareTo(s3) is %d", s4.compareTo(s3));
