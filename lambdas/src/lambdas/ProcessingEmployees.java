...
public class ProcessingEmployees {
	...
	public static void main(String[] args) {
		...
		Employee[] employees = {
				...
				new Employee("Json", "Blue", 3200, "Sales"),
				new Employee("Wendy", "Brown", 4236.4, "Marketing")
		};
		
		// obtém a vizualização List dos Employees
		...
		// conta o número de Employyes em cada departamento
		...
		System.out.printf("Avarage of Employees' salaries: %.2f%n",
				list.stream()
				.mapToDouble(Employee::getSalary)
				.average()
				.getAsDouble());
