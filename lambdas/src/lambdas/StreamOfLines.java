...
public class StreamOfLines {
	...
	public static void main(String[] args) throws IOException {
		...
		Map<String, Long> wordCounts = 
				...
				.map(line -> line.replaceAll("(?!)\\p{P}", "")) // remove toda a pontuação exceto apóstrofo
				.flatMap(line -> pattern.splitAsStream(line)) // método Stream flatMap para dividir cada linha de texto em palavras separadas
